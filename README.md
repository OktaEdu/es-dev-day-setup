# Deploy a custom app with Terraform
This readme covers configuring the environment that is required to complete this [Deploy a Custom SPA App with Terraform](https://github.com/OktaEdu/deploy-a-custom-app) lab.
## Setup Video
